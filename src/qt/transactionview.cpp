                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received DLN from zDLN"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zDLN"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMILLENIUMCLUBCOIN));
