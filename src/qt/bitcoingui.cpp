                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Millenniumclubcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Millenniumclubcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and millenniumclubcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDLN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Millenniumclubcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Millenniumclubcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Millenniumclubcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Millenniumclubcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Millenniumclubcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Millenniumclubcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Millenniumclubcoin Core help message to get a list with possible Millenniumclubcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Millenniumclubcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Millenniumclubcoin network", "", count));
}
...
{
    QString strTitle = tr("Millenniumclubcoin Core"); // default title
    ...
    // Append title to "Millenniumclubcoin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
...
/** Creates context menu, its actions, and millenniumclubcoins up all the relevant signals for mouse events. */
