...
empty := 
space := $(empty) $(empty)
OSX_APP = MILLENNIUMCLUBCOIN-Qt.app
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/MILLENNIUMCLUBCOIN-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/MILLENNIUMCLUBCOIN-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/MILLENNIUMCLUBCOIN-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/MILLENNIUMCLUBCOIN-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
